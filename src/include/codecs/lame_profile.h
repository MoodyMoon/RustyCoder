...
#ifndef CODECS_LAME_PROFILE_H
#define CODECS_LAME_PROFILE_H

#include "../core/exception.h"
#include "encoder_profile.h"
#include "common.h"
...
namespace codecs
{
class LameProfile : public EncoderProfile
{
    public:
        /*!
        Similar to \c -q in lame command line
        */
        enum class AlgorithmQuality : LAME_ALGORITHM_QUALITY_DATA_TYPE
        {
        ...
        */
        enum class Mode : LAME_MODE_DATA_TYPE
        {
            STEREO = 0,       /*!< <tt>-m s</tt> */
        ...
        */
        enum class ReplayGain : LAME_REPLAYGAIN_DATA_TYPE
        {
        ...
        */
        enum class BitrateEncoding : LAME_BITRATE_ENCODING_DATA_TYPE
        {
        ...
        */
        enum class Bitrate : LAME_BITRATE_DATA_TYPE
        {
            B_8 = 8,
            B_16 = 16,
            B_24 = 24,
    ...
    private:
        ...
        void SetMinOrMaxBitrate(LAME_BITRATE_DATA_TYPE min_or_max_bitrate, bool one);
    ...
    public:
        ...
        void SetAlgorithmQuality(LAME_ALGORITHM_QUALITY_DATA_TYPE algorithm_quality);
        void SetMode(LAME_MODE_DATA_TYPE mode);
        void SetReplayGainMode(LAME_REPLAYGAIN_DATA_TYPE replaygain_mode);
        void SetCopyright(bool copyright);
        void SetUseNaokiPsytune(bool use_naoki_psytune);
        void SetBitrateEncoding(LAME_BITRATE_ENCODING_DATA_TYPE bitrate_encoding);
        void SetVbrQuality(float vbr_quality);
        void SetMinOrMaxBitrate1(LAME_BITRATE_DATA_TYPE min_or_max_bitrate1);
        void SetMinOrMaxBitrate2(LAME_BITRATE_DATA_TYPE min_or_max_bitrate2);
