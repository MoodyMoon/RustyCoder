...
#ifndef CODECS_SNDFILE_DECODER_H
#define CODECS_SNDFILE_DECODER_H
...
class SndFileDecoder : public Decoder<T>
{
    private:
        ...
        void SndFileDecoder2(const boost::filesystem::path path, T *container, uint64_t container_size);
    ...
    public:
        ...
        */
        SndFileDecoder(const boost::filesystem::path path, T * container, uint64_t container_size);
...
class SndFileDecoder<void> : public Decoder<void>
{
    ...
    public:
        ...
        \throw ReadFileException
        */
        SndFileDecoder(const boost::filesystem::path path);
