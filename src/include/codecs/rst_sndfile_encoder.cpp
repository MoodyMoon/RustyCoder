...
const std::map<const SndFileEncoderOptions::OutputFormat, const char *> SndFileEncoderOptions::output_format_to_file_extension = {
        /*! WAV (Microsoft) */
...
const std::map<const SndFileEncoderOptions::OutputFormat, const char *> SndFileEncoderOptions::output_format_to_text = {
        /*! WAV (Microsoft) */
...
const std::map<const char *, const SndFileEncoderOptions::OutputFormat> SndFileEncoderOptions::text_to_output_format = {
        /*! WAV (Microsoft) */
...
bool SndFileEncoderOptions::SetOutputFormat(uint32_t output_format)
{
